    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alcherid', models.TextField(blank=True, default=users.models.create_new_ref_number, unique=True)),
                ...
                ('instahandle', models.CharField(blank=True, max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fb_handle', models.CharField(blank=True, default='', max_length=200, null=True)),
                ('update_status', models.IntegerField(blank=True, default=0, null=True)),
                ('phoneno', models.CharField(blank=True, default='', max_length=10, null=True)),
                ('countrycode', models.CharField(blank=True, default='+91', max_length=3, null=True)),
